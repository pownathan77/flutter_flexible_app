...
class FadeInOut extends StatelessWidget {
  ...
  FadeInOut(this.delay, this.child);
  ...
  ..addScene(begin: 1500.milliseconds, duration: 1000.milliseconds)
        .animate(AnimationProp.opacity, tween: 1.0.tweenTo(1.0))
  ..addScene(begin: 2500.milliseconds, duration: 1500.milliseconds)
        .animate(AnimationProp.opacity, tween: 1.0.tweenTo(0.0));
